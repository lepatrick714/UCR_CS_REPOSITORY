/*
Programmers: Lam Duy Le and Joshua Jeon
*/
...
class PrintVisitor : public Visitor {
    ...
    public:
        ...
        void rootNode() {};
        void sqrNode() { output+="^2 "; };
        void multNode() { output+="* "; };
        void subNode() { output+="- "; };
        void addNode() { output+="+ "; };
        void opNode(Op* op) { ostringstream s; s << op->evaluate(); output+=s.str(); output+=" ";};

        void execute() { cout << output << endl; };
};

void Op::accept(Visitor *a) { a->opNode(this); };
...
class Add: public Operator {
    public:
        ...
        void accept(Visitor *a) { a->addNode(); };
};
...
class Sub: public Operator {
    public:
        ...
        void print() { cout << "-"; };
        double evaluate() { return this->left->evaluate() * this->right->evaluate(); };
        void accept(Visitor *a) { a->subNode(); };
};
...
class Mult: public Operator {
    public:
        ...
        void print() { cout << "*"; };
        double evaluate() { return this->left->evaluate() * this->right->evaluate(); };
        void accept(Visitor *a) { a->multNode(); };
};
...
class Sqr: public UnaryOperator {
    public:
        ...
        void accept(Visitor *a) { a->sqrNode(); };
};
...
class Root: public UnaryOperator {
    public:
        ...
        void accept(Visitor *a) { a->rootNode(); };
};
